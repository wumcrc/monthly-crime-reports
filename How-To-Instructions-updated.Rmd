...
Once you have run the `data-creation.Rmd` you need to run the `fpse-bot-cwe-mc-presentation.Rmd`. Before you run this notebook, you need to change the params.  
          ...
          `num` Num refers to the column of the current month. Because months come in pairs in this dataset, if the month is first (i.e. January in Jan-Feb, or March in Mar-Apr) then the num should be set to 2. If it comes second (i.e. Feb in Jan-Feb, or Apr in Mar-Apr) then num should be set to 3.
