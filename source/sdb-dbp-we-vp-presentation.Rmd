...
tc_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 46,])
tc_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 46,])
cap_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 46 & monthCrimes_past$crimeCatNum == 4 | monthCrimes_past$neighborhood == 46 & monthCrimes_past$crimeCatNum == 3,])
cap_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 46 & monthCrimes_pres$crimeCatNum == 4 | monthCrimes_pres$neighborhood == 46 & monthCrimes_pres$crimeCatNum == 3,])

tc_ytd_past <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 46,])
tc_ytdCurrent <- nrow(ytdCrimes[ytdCrimes$neighborhood == 46,])
cap_past_ytd <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 46 & ytdCrimes_past$crimeCatNum == 4 | ytdCrimes_past$neighborhood == 46 & ytdCrimes_past$crimeCatNum == 3,])
cap_pres_ytd <- nrow(ytdCrimes[ytdCrimes$neighborhood == 46 & ytdCrimes$crimeCatNum == 4 | ytdCrimes$neighborhood == 46 & ytdCrimes$crimeCatNum == 3,])
...
ytdCrimes %>%
  ...
  rename(., "Number of Crimes" = n) %>%
  pivot_wider(names_from = monthVar, values_from = "Number of Crimes") %>%
  replace(., is.na(.), 0) -> sdb_pres
```

```{r SDB Total Crimes Flextable past year, echo = FALSE}
part1crimes[!(part1crimes %in% sdb_past$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(sdb_past, crimeCatName = missing_category) -> sdb_past
}
...
sdb_past %>% 
  ...
  rename(., "Part 1 Crimes" = crimeCatName) -> sdb_past
...
```{r SDB Total Crimes Flextable current year, echo = FALSE}
part1crimes[!(part1crimes %in% sdb_pres$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(sdb_pres, crimeCatName = missing_category) -> sdb_pres
}
...
sdb_pres %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> sdb_pres

#compare dataframes and get common columns
common_cols <- intersect(colnames(sdb_pres[, (params$num + 1)]), colnames(sdb_past[, (params$num + 1)]))

#assign to temporary dataframe
temp_past <- sdb_past[,common_cols, drop=FALSE]
temp_pres <- sdb_pres[,common_cols, drop=FALSE]
...
sub <- filter(monthCrimes_pres_sf, neighborhood == 46)
col <- character(0)
...
tc_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 47,])
tc_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 47,])
cap_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 47 & monthCrimes_past$crimeCatNum == 4 | monthCrimes_past$neighborhood == 47 & monthCrimes_past$crimeCatNum == 3,])
cap_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 47 & monthCrimes_pres$crimeCatNum == 4 | monthCrimes_pres$neighborhood == 47 & monthCrimes_pres$crimeCatNum == 3,])

tc_ytd_past <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 47,])
tc_ytdCurrent <- nrow(ytdCrimes[ytdCrimes$neighborhood == 47,])
cap_past_ytd <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 47 & ytdCrimes_past$crimeCatNum == 4 | ytdCrimes_past$neighborhood == 47 & ytdCrimes_past$crimeCatNum == 3,])
cap_pres_ytd <- nrow(ytdCrimes[ytdCrimes$neighborhood == 47 & ytdCrimes$crimeCatNum == 4 | ytdCrimes$neighborhood == 47 & ytdCrimes$crimeCatNum == 3,])
...
ytdCrimes %>%
  ...
  rename(., "Number of Crimes" = n) %>%
  pivot_wider(names_from = monthVar, values_from = "Number of Crimes") %>%
  replace(., is.na(.), 0) -> dbp_pres
```

```{r DBP Total Crimes Flextable past year, echo = FALSE}
part1crimes[!(part1crimes %in% dbp_past$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(dbp_past, crimeCatName = missing_category) -> dbp_past
}
...
dbp_past %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> dbp_past
...
```{r dbp Total Crimes Flextable current year, echo = FALSE}
part1crimes[!(part1crimes %in% dbp_pres$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(dbp_pres, crimeCatName = missing_category) -> dbp_pres
}
...
dbp_pres %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> dbp_pres

#compare dataframes and get common columns
common_cols <- intersect(colnames(dbp_pres[, (params$num + 1)]), colnames(dbp_past[, (params$num + 1)]))

#assign to temporary dataframe
temp_past <- dbp_past[,common_cols, drop=FALSE]
temp_pres <- dbp_pres[,common_cols, drop=FALSE]
...
sub <- filter(monthCrimes_pres_sf, neighborhood == 47)
col <- character(0)
if("Aggravated Assault" %in% sub$crimeCatName){col <- c("Aggravated Assault" = "#e41a1c")}
if("Arson" %in% sub$crimeCatName){col <- c(col, "Arson" = "#A65628")}
if("Burgalry" %in% sub$crimeCatName){col <- c(col, "Burgalry" = "#377eb8")}
...
tc_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 48,])
tc_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 48,])
cap_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 48 & monthCrimes_past$crimeCatNum == 4 | monthCrimes_past$neighborhood == 48 & monthCrimes_past$crimeCatNum == 3,])
cap_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 48 & monthCrimes_pres$crimeCatNum == 4 | monthCrimes_pres$neighborhood == 48 & monthCrimes_pres$crimeCatNum == 3,])

tc_ytd_past <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 48,])
tc_ytdCurrent <- nrow(ytdCrimes[ytdCrimes$neighborhood == 48,])
cap_past_ytd <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 48 & ytdCrimes_past$crimeCatNum == 4 | ytdCrimes_past$neighborhood == 48 & ytdCrimes_past$crimeCatNum == 3,])
cap_pres_ytd <- nrow(ytdCrimes[ytdCrimes$neighborhood == 48 & ytdCrimes$crimeCatNum == 4 | ytdCrimes$neighborhood == 48 & ytdCrimes$crimeCatNum == 3,])
...
ytdCrimes %>%
  ...
  rename(., "Number of Crimes" = n) %>%
  pivot_wider(names_from = monthVar, values_from = "Number of Crimes") %>%
  replace(., is.na(.), 0) -> we_pres
```

```{r WE Total Crimes Flextable past year, echo = FALSE}
part1crimes[!(part1crimes %in% we_past$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(we_past, crimeCatName = missing_category) -> we_past
}
...
we_past %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> we_past
...
```{r we Total Crimes Flextable current year, echo = FALSE}
part1crimes[!(part1crimes %in% we_pres$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(we_pres, crimeCatName = missing_category) -> we_pres
}
...
we_pres %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> we_pres

#compare dataframes and get common columns
common_cols <- intersect(colnames(we_pres[, (params$num + 1)]), colnames(we_past[, (params$num + 1)]))

#assign to temporary dataframe
temp_past <- we_past[,common_cols, drop=FALSE]
temp_pres <- we_pres[,common_cols, drop=FALSE]
...
sub <- filter(monthCrimes_pres_sf, neighborhood == 48)
col <- character(0)
if("Aggravated Assault" %in% sub$crimeCatName){col <- c("Aggravated Assault" = "#e41a1c")}
if("Arson" %in% sub$crimeCatName){col <- c(col, "Arson" = "#A65628")}
if("Burgalry" %in% sub$crimeCatName){col <- c(col, "Burgalry" = "#377eb8")}
...
tc_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 49,])
tc_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 49,])
cap_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 49 & monthCrimes_past$crimeCatNum == 4 | monthCrimes_past$neighborhood == 49 & monthCrimes_past$crimeCatNum == 3,])
cap_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 49 & monthCrimes_pres$crimeCatNum == 4 | monthCrimes_pres$neighborhood == 49 & monthCrimes_pres$crimeCatNum == 3,])

tc_ytd_past <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 49,])
tc_ytdCurrent <- nrow(ytdCrimes[ytdCrimes$neighborhood == 49,])
cap_past_ytd <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 49 & ytdCrimes_past$crimeCatNum == 4 | ytdCrimes_past$neighborhood == 49 & ytdCrimes_past$crimeCatNum == 3,])
cap_pres_ytd <- nrow(ytdCrimes[ytdCrimes$neighborhood == 49 & ytdCrimes$crimeCatNum == 4 | ytdCrimes$neighborhood == 49 & ytdCrimes$crimeCatNum == 3,])
...
ytdCrimes %>%
  ...
  rename(., "Number of Crimes" = n) %>%
  pivot_wider(names_from = monthVar, values_from = "Number of Crimes") %>%
  replace(., is.na(.), 0) -> vp_pres
```

```{r vp Total Crimes Flextable past year, echo = FALSE}
part1crimes[!(part1crimes %in% vp_past$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(vp_past, crimeCatName = missing_category) -> vp_past
}
...
vp_past %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> vp_past
...
```{r vp Total Crimes Flextable current year, echo = FALSE}
part1crimes[!(part1crimes %in% vp_pres$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(vp_pres, crimeCatName = missing_category) -> vp_pres
}
...
vp_pres %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> vp_pres

#compare dataframes and get common columns
common_cols <- intersect(colnames(vp_pres[, (params$num + 1)]), colnames(vp_past[, (params$num + 1)]))

#assign to temporary dataframe
temp_past <- vp_past[,common_cols, drop=FALSE]
temp_pres <- vp_pres[,common_cols, drop=FALSE]
...
sub <- filter(monthCrimes_pres_sf, neighborhood == 49)
col <- character(0)
if("Aggravated Assault" %in% sub$crimeCatName){col <- c("Aggravated Assault" = "#e41a1c")}
if("Arson" %in% sub$crimeCatName){col <- c(col, "Arson" = "#A65628")}
if("Burgalry" %in% sub$crimeCatName){col <- c(col, "Burgalry" = "#377eb8")}
