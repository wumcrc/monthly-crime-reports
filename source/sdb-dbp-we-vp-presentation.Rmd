...
report%>%
  ...
  ph_with(paste("Skinker DeBaliviere: Crime Density Map", params$year, sep = " "),
               location = ph_location_type(
                 type = "title") )-> report
```
...
report%>%
  ...
  ph_with(paste("DeBaliviere Place: Crime Density Map", params$year, sep = " "),
               location = ph_location_type(
                 type = "title") )-> report
```
...
report%>%
  ...
  ph_with(paste("West End: Crime Density Map", params$year, sep = " "),
               location = ph_location_type(
                 type = "title") )-> report
```
