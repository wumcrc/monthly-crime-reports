...
for ( i in list(sdb_tiles, dbp_tiles, we_tiles, vp_tiles) ) { 
name <- comment(i)
...
file <- read_pptx(here::here("results", "presentations",  params$year, params$month, paste("sdbp-dbp-we-vp-", params$month, params$year, ".pptx", sep = "")))
