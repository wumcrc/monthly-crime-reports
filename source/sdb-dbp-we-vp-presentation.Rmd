...
common_cols <- intersect(colnames(sdb_2020), colnames(sdb_2019))
#drop columns that aren't shared
sdb_2020 <- sdb_2020[,common_cols, drop=FALSE]
sdb_2019 <- sdb_2019[,common_cols, drop=FALSE]
#assign colors, green is a decrease in crime, red is an increase, transparent is no change
colors <- unlist(sdb_2020[-1] - sdb_2019[-1]) %>% 
...
#compare dataframes and get common columns
common_cols <- intersect(colnames(dbp_2020), colnames(dbp_2019))
#drop columns that aren't shared
dbp_2020 <- dbp_2020[,common_cols, drop=FALSE]
dbp_2019_sub <- dbp_2019[,common_cols, drop=FALSE]
#assign colors, green is a decrease in crime, red is an increase, transparent is no change
colors <- unlist(dbp_2020[-1] - dbp_2019_sub[-1]) %>% 
  cut(breaks = c(-Inf, -.1, 0.1, Inf),
      labels = c("green", "transparent", "red")) %>% 
  as.character()
#make flextable, color all columns except the first
...
#compare dataframes and get common columns
common_cols <- intersect(colnames(we_2020), colnames(we_2019))
#drop columns that aren't shared
we_2020 <- we_2020[,common_cols, drop=FALSE]
we_2019_sub <- we_2019[,common_cols, drop=FALSE]
#assign colors, green is a decrease in crime, red is an increase, transparent is no change
colors <- unlist(we_2020[-1] - we_2019_sub[-1]) %>% 
  cut(breaks = c(-Inf, -.1, 0.1, Inf),
      labels = c("green", "transparent", "red")) %>% 
  as.character()
#make flextable, color all columns except the first
...
#compare dataframes and get common columns
common_cols <- intersect(colnames(vp_2020), colnames(vp_2019))
#drop columns that aren't shared
vp_2020 <- vp_2020[,common_cols, drop=FALSE]
vp_2019_sub <- vp_2019[,common_cols, drop=FALSE]
#assign colors, green is a decrease in crime, red is an increase, transparent is no change
colors <- unlist(vp_2020[-1] - vp_2019_sub[-1]) %>% 
  cut(breaks = c(-Inf, -.1, 0.1, Inf),
      labels = c("green", "transparent", "red")) %>% 
  as.character()
#make flextable, color all columns except the first
