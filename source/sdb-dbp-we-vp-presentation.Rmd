...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "sdb", "sdb_total_tm.jpeg"), width = 8.09, height = 6), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "dbp", "dbp_total_crimes.jpeg"), width = 6.97, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "we", "we_total_crimes.jpeg"), width = 9.5, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "vp", "vp_total_tm.jpeg"), width = 5.31, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "sdb", "sdb_day_night.jpeg"), width = 8.09, height = 6), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "sdb", "sdb_vlnt.jpeg"), width = 8.09, height = 6), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "sdb", "sdb_density.jpeg"), width = 8.09, height = 6), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
ggsave(here("results", params$year, params$month, "sdb", "sdb_crime_timeDay_graph.jpeg"), dpi = 500)

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "sdb", "sdb_crime_timeDay_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
ggsave(here("results", params$year, params$month, "sdb", "sdb_crimeCat_weekday_graph.jpeg"), dpi = 500)

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "sdb", "sdb_crimeCat_weekday_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "dbp", "dbp_day_night.jpeg"), width = 6.97, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "dbp", "dbp_vlnt.jpeg"), width = 6.97, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "dbp", "dbp_density.jpeg"), width = 6.97, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
ggsave(here("results", params$year, params$month, "dbp", "dbp_crime_timeDay_graph.jpeg"), dpi = 500)

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "dbp", "dbp_crime_timeDay_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
ggsave(here("results", params$year, params$month, "dbp", "dbp_crimeCat_weekday_graph.jpeg"), dpi = 500)

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "dbp", "dbp_crimeCat_weekday_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "we", "we_day_night.jpeg"), width = 9.5, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "we", "we_vlnt.jpeg"), width = 9.5, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "we", "we_density.jpeg"), width = 9.5, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
ggsave(here("results", params$year, params$month, "we", "we_crime_timeDay_graph.jpeg"), dpi = 500)

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "we", "we_crime_timeDay_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
  ph_with("West End: Total Crimes by Days of the Week", 
               location = ph_location_type(
                 type = "title") )-> report
...
ggsave(here("results", params$year, params$month, "we", "we_crimeCat_weekday_graph.jpeg"), dpi = 500)

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "we", "we_crimeCat_weekday_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "vp", "vp_day_night.jpeg"), width = 5.31, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "vp", "vp_vlnt.jpeg"), width = 5.31, height = 7.5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
  ph_with("Visitation Park: Time of Crimes Map", 
               location = ph_location_type(
                 type = "title") )-> report
```
...
ggsave(here("results", params$year, params$month, "vp", "vp_crime_timeDay_graph.jpeg"), dpi = 500)

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "vp", "vp_crime_timeDay_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
ggsave(here("results", params$year, params$month, "vp", "vp_crimeCat_weekday_graph.jpeg"), dpi = 500)

#add to powerpoint report
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "vp", "vp_crimeCat_weekday_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
print(report, target = here::here("results", "presentations",  params$year, params$month,  "sdb-dbp-we-vp-presentation.pptx"))
```
