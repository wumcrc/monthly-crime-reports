...
file.remove(file.path(mydir, dir(path = mydir, pattern = "sdbp-dbp-we-vp-")))
...
convert_to_pdf(path = here::here("results", "presentations",  params$year, params$month, paste("sdbp-dbp-we-vp-", params$month, params$year, ".pptx", sep = "")),
               pdf_file = sub("[.]pptx", ".pdf", paste("~/Documents/GitHub/crime_interactive/crime_interactive/www/", "sdbp-dbp-we-vp-", params$month, params$year, ".pptx", sep = "")))
```
