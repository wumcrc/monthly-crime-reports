...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "ac",
                                  "ac_crime_timeDay_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "ac",
                                  "ac_crimeCat_weekday_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "fp",
                                  "fp_crime_timeDay_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "fp",
                                  "fp_crimeCat_weekday_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "lp",
                                  "lp_crime_timeDay_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "lp",
                                  "lp_crimeCat_weekday_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "vd",
                                  "vd_crime_timeDay_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "vd",
                                  "vd_crimeCat_weekday_graph.jpeg"), width = 9, height = 5.45),
          location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
print(report, target = here::here("results", "presentations",  params$year, params$month,  "ac-fp-lp-vd-presentation.pptx"))
```
