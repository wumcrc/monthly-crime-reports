...
report%>%
  ...
  ph_with(paste("Academy: Crime Density Map", params$year, sep = " "),
               location = ph_location_type(
                 type = "title") )-> report
```
...
report%>%
  ...
  ph_with(paste("Fountain Park: Crime Density Map", params$year, sep = " "),
               location = ph_location_type(
                 type = "title") )-> report
```
...
report%>%
  ...
  ph_with(paste("Lewis Place: Crime Density Map", params$year, sep = " "),
               location = ph_location_type(
                 type = "title") )-> report
```
...
report%>%
  ...
  ph_with(paste("Vandeventer: Crime Density Map", params$year, sep = " "),
               location = ph_location_type(
                 type = "title") )-> report
```
