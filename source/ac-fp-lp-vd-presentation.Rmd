...
common_cols <- intersect(colnames(ac_2020[, (params$num + 1)]), colnames(ac_2019[, (params$num + 1)]))

#assign to temporary dataframe
temp19 <- ac_2019[,common_cols, drop=FALSE]
temp20 <- ac_2020[,common_cols, drop=FALSE]
...
#compare dataframes and get common columns
common_cols <- intersect(colnames(fp_2020[, (params$num + 1)]), colnames(fp_2019[, (params$num + 1)]))

#assign to temporary dataframe
temp19 <- fp_2019[,common_cols, drop=FALSE]
temp20 <- fp_2020[,common_cols, drop=FALSE]
...
#compare dataframes and get common columns
common_cols <- intersect(colnames(lp_2020[, (params$num + 1)]), colnames(lp_2019[, (params$num + 1)]))

#assign to temporary dataframe
temp19 <- lp_2019[,common_cols, drop=FALSE]
temp20 <- lp_2020[,common_cols, drop=FALSE]
...
#compare dataframes and get common columns
common_cols <- intersect(colnames(vd_2020[, (params$num + 1)]), colnames(vd_2019[, (params$num + 1)]))

#assign to temporary dataframe
temp19 <- vd_2019[,common_cols, drop=FALSE]
temp20 <- vd_2020[,common_cols, drop=FALSE]
