...
style1 <- fp_text(color = "black", font.size = 28, bold = TRUE, underlined = TRUE)
style2 <- fp_text(color = 'black', font.size = 24)
style3 <- fp_text(color = 'green', font.size = 24)
style4 <- fp_text(color = "black", font.size = 24, bold = TRUE)
style5 <- fp_text(color = "black", font.size = 20)
style6 <- fp_text(color = "green", font.size = 20)

bullet1 <- fpar(ftext(sprint_1, prop = style1))

bullet2 <- ftext(paste("compared to this time in ", params$pastyear, " (", tc_ytd19, " total crimes)", sep = ""), prop = style2) 
    ftext(paste(pct_chg_mth, "change ", sep = " "), prop = style3)

test <- unordered_list(
  level_list = c(1, 2),
str_list = c(bullet1, bullet2)
)

report%>%
  add_slide()%>%
  ph_with(value = c(bullet1, bullet2), location = ph_location_type("body")) -> report
  ph_with(value = bullet2, location = ph_location_type("body")) -> report
...
report%>%
  ...
  if(pct_chg_mth1 == 0){
    ph_add_text(str = paste(pct_chg_mth, "change ", sep = " "), 
              style =  fp_text(color = 'blue', font.size = 24))
  }%>%
    ph_add_par(level = 2L) %>%
    ph_add_text(str = paste(" in", params$month, params$year, sep = " "), 
                style = fp_text(color = "black", font.size = 24))%>%
    ph_add_text(str = paste(cap20, "crime(s) against persons", sep = " "), 
                style = fp_text(color = "black", font.size = 24, bold = TRUE)) %>%
    ph_add_par(level = 3L) %>%
    ph_add_text(str = paste(" compared to ", params$month, " ", params$pastyear, " (", cap19, " crimes against persons)", sep = ""), style = fp_text(color = "black", font.size = 20))%>%
    ph_add_text(str = paste(pct_chg_cap, "change", sep = " "), 
                style = fp_text(color = "green", font.size = 20))%>%
    ph_add_par(level = 1L) %>%
    ph_add_text(str = sprint_5, style = fp_text(color = "black", font.size = 28, bold = TRUE, underlined = TRUE))%>%
    ph_add_par(level = 2L)%>%
  ...
  ph_add_text(str = paste(pct_chg_ytd, "change ", sep = " "), 
              style =  fp_text(color = 'green', font.size = 24)) %>%
    ph_add_par(level = 2L) %>%
    ...
    ph_add_text(str = paste(cap20_ytd, "crime(s) against persons", sep = " "), 
                style = fp_text(color = "black", font.size = 24, bold = TRUE)) %>%
    ph_add_par(level = 3L) %>%
    ph_add_text(str = paste(" compared to this time in ", params$pastyear, " (", cap19_ytd, " crimes against persons)", sep = ""), style = fp_text(color = "black", font.size = 20))%>%
    ph_add_text(str = paste(pct_chg_ytd_cap, "change", sep = " "), 
                style = fp_text(color = "green", font.size = 20)) -> report

unordered_list(
level_list = c(1, 2, 2, 3, 1, 2, 2, 3),
str_list = c(sprint_1, sprint_2, sprint_3, sprint_4, sprint_5, sprint_6, sprint_7, sprint_8),
style = list(
  fp_text(color = "black", font.size = 28, bold = TRUE, underlined = TRUE),
  fp_text(color = "black", font.size = 24),
  fp_text(color = "black", font.size = 24, bold = TRUE),
  fp_text(color = "black", font.size = 20),
  fp_text(color = "black", font.size = 28, bold = TRUE, underlined = TRUE),
  fp_text(color = "black", font.size = 24),
  fp_text(color = "black", font.size = 24, bold = TRUE),
  fp_text(color = "black", font.size = 20)
...
report%>%
  add_slide()%>%
  ph_with(value = "blah blah blah", location = ph_location_type("body"))%>%
  ifelse(pct_chg_mth1 >= 0, (ph_add_text(str = paste(pct_chg_mth, "change ", sep = " "), 
              style =  fp_text(color = 'green', font.size = 24))), (ph_add_text(str = paste(pct_chg_mth, "change ", sep = " "), 
              style =  fp_text(color = 'red', font.size = 24)))) -> report

report%>%
  add_slide(layout = "Title and Content", master = "Office Theme")%>%
  ph_with(value = "Academy: Summary Notes", location = ph_location_type(type = "title"))%>%
  ph_with(list, location = ph_location_type(type = "body")) -> report
...
report%>%
  ...
  phl_with_flextable(olay = offlayout, 4, flex02)%>%
...
report%>%
  add_slide()%>%
  ph_with("Fountain Park: Year to Year Comparison", 
               location = ph_location_type(
                 type = "title"))%>%
  phl_with_flextable(olay = offlayout01, 2, flex)%>%
  phl_with_flextable(olay = offlayout01, 3, flex01) -> report
...
report%>%
  add_slide()%>%
  ph_with("Lewis Place: Year to Year Comparison", 
               location = ph_location_type(
                 type = "title"))%>%
  phl_with_flextable(olay = offlayout01, 2, flex)%>%
  phl_with_flextable(olay = offlayout01, 3, flex01) -> report
...
report%>%
  add_slide()%>%
  ph_with("Vandeventer: Year to Year Comparison", 
               location = ph_location_type(
                 type = "title"))%>%
  phl_with_flextable(olay = offlayout01, 2, flex)%>%
  phl_with_flextable(olay = offlayout01, 3, flex01) -> report
...
report%>%
  ...
  ph_with(external_img(here::here("results", params$year, params$month, "ac",
                                  "ac_crime_weekday_graph.jpeg"), width = 7, height = 4),
          location = ph_location_type())%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "ac",
                                  "ac_crime_timeDay_graph.jpeg"), width = 7, height = 4),
          location = ph_location_type())%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "ac",
                                  "ac_crimeCat_weekday_graph.jpeg"), width = 7, height = 4),
          location = ph_location_type())%>%
...
report%>%
  ...
  ph_with(external_img(here::here("results", params$year, params$month, "fp",
                                  "fp_crime_weekday_graph.jpeg"), width = 7, height = 4),
          location = ph_location_type())%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "fp",
                                  "fp_crime_timeDay_graph.jpeg"), width = 7, height = 4),
          location = ph_location_type())%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "fp",
                                  "fp_crimeCat_weekday_graph.jpeg"), width = 7, height = 4),
          location = ph_location_type())%>%
...
report%>%
  ...
  ph_with(external_img(here::here("results", params$year, params$month, "lp",
                                  "lp_crime_weekday_graph.jpeg"), width = 7, height = 4),
          location = ph_location_type())%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "lp",
                                  "lp_crime_timeDay_graph.jpeg"), width = 7, height = 4),
          location = ph_location_type())%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "lp",
                                  "lp_crimeCat_weekday_graph.jpeg"), width = 7, height = 4),
          location = ph_location_type())%>%
...
report%>%
  ...
  ph_with(external_img(here::here("results", params$year, params$month, "vd",
                                  "vd_crime_weekday_graph.jpeg"), width = 7, height = 4),
          location = ph_location_type())%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "vd",
                                  "vd_crime_timeDay_graph.jpeg"), width = 7, height = 4),
          location = ph_location_type())%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "vd",
                                  "vd_crimeCat_weekday_graph.jpeg"), width = 7, height = 4),
          location = ph_location_type())%>%
