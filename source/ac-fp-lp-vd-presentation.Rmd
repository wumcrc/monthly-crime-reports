...
report%>%
  ...
  ph_with(value = "Academy, Fountain Park, Lewis Place Place, Vandeventer", location = ph_location_type(type = "ctrTitle"))%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "district-5", "dst5_rates.jpeg"), width = 9, height = 5), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide(layout = "Title Slide", master = "Office Theme")%>%
  ph_with(value = "Vandevneter: Neighborhood Detail", location = ph_location_type(type = "ctrTitle"))%>%
