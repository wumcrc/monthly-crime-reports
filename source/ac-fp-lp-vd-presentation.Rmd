...
tc_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 51,])
tc_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 51,])
cap_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 51 & monthCrimes_past$crimeCatNum == 4 | monthCrimes_past$neighborhood == 51 & monthCrimes_past$crimeCatNum == 3,])
cap_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 51 & monthCrimes_pres$crimeCatNum == 4 | monthCrimes_pres$neighborhood == 51 & monthCrimes_pres$crimeCatNum == 3,])

tc_ytd_past <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 51,])
tc_ytdCurrent <- nrow(ytdCrimes[ytdCrimes$neighborhood == 51,])
cap_past_ytd <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 51 & ytdCrimes_past$crimeCatNum == 4 | ytdCrimes_past$neighborhood == 51 & ytdCrimes_past$crimeCatNum == 3,])
cap_pres_ytd <- nrow(ytdCrimes[ytdCrimes$neighborhood == 51 & ytdCrimes$crimeCatNum == 4 | ytdCrimes$neighborhood == 51 & ytdCrimes$crimeCatNum == 3,])
...
ytdCrimes %>%
  ...
  rename(., "Number of Crimes" = n) %>%
  pivot_wider(names_from = monthVar, values_from = "Number of Crimes") %>%
  replace(., is.na(.), 0) -> ac_pres
```

```{r AC Total Crimes Flextable past year, echo = FALSE}
part1crimes[!(part1crimes %in% ac_past$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(ac_past, crimeCatName = missing_category) -> ac_past
}
...
ac_past %>% 
  ...
  rename(., "Part 1 Crimes" = crimeCatName) -> ac_past
...
```{r ac Total Crimes Flextable current year, echo = FALSE}
part1crimes[!(part1crimes %in% ac_pres$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(ac_pres, crimeCatName = missing_category) -> ac_pres
}
...
ac_pres %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> ac_pres

#compare dataframes and get common columns
common_cols <- intersect(colnames(ac_pres[, (params$num + 1)]), colnames(ac_past[, (params$num + 1)]))

#assign to temporary dataframe
temp_past <- ac_past[,common_cols, drop=FALSE]
temp_pres <- ac_pres[,common_cols, drop=FALSE]
...
sub <- filter(monthCrimes_pres_sf, neighborhood == 51)
col <- character(0)
...
tc_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 53,])
tc_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 53,])
cap_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 53 & monthCrimes_past$crimeCatNum == 4 | monthCrimes_past$neighborhood == 53 & monthCrimes_past$crimeCatNum == 3,])
cap_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 53 & monthCrimes_pres$crimeCatNum == 4 | monthCrimes_pres$neighborhood == 53 & monthCrimes_pres$crimeCatNum == 3,])

tc_ytd_past <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 53,])
tc_ytdCurrent <- nrow(ytdCrimes[ytdCrimes$neighborhood == 53,])
cap_past_ytd <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 53 & ytdCrimes_past$crimeCatNum == 4 | ytdCrimes_past$neighborhood == 53 & ytdCrimes_past$crimeCatNum == 3,])
cap_pres_ytd <- nrow(ytdCrimes[ytdCrimes$neighborhood == 53 & ytdCrimes$crimeCatNum == 4 | ytdCrimes$neighborhood == 53 & ytdCrimes$crimeCatNum == 3,])
...
ytdCrimes %>%
  ...
  rename(., "Number of Crimes" = n) %>%
  pivot_wider(names_from = monthVar, values_from = "Number of Crimes") %>%
  replace(., is.na(.), 0) -> fp_pres
```

```{r FP Total Crimes Flextable past year, echo = FALSE}
part1crimes[!(part1crimes %in% fp_past$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(fp_past, crimeCatName = missing_category) -> fp_past
}
...
fp_past %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> fp_past
...
```{r fp Total Crimes Flextable current year, echo = FALSE}
part1crimes[!(part1crimes %in% fp_pres$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(fp_pres, crimeCatName = missing_category) -> fp_pres
}
...
fp_pres %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> fp_pres

#compare dataframes and get common columns
common_cols <- intersect(colnames(fp_pres[, (params$num + 1)]), colnames(fp_past[, (params$num + 1)]))

#assign to temporary dataframe
temp_past <- fp_past[,common_cols, drop=FALSE]
temp_pres <- fp_pres[,common_cols, drop=FALSE]
...
sub <- filter(monthCrimes_pres_sf, neighborhood == 53)
col <- character(0)
if("Aggravated Assault" %in% sub$crimeCatName){col <- c("Aggravated Assault" = "#e41a1c")}
if("Arson" %in% sub$crimeCatName){col <- c(col, "Arson" = "#A65628")}
if("Burgalry" %in% sub$crimeCatName){col <- c(col, "Burgalry" = "#377eb8")}
...
tc_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 54,])
tc_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 54,])
cap_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 54 & monthCrimes_past$crimeCatNum == 4 | monthCrimes_past$neighborhood == 54 & monthCrimes_past$crimeCatNum == 3,])
cap_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 54 & monthCrimes_pres$crimeCatNum == 4 | monthCrimes_pres$neighborhood == 54 & monthCrimes_pres$crimeCatNum == 3,])

tc_ytd_past <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 54,])
tc_ytdCurrent <- nrow(ytdCrimes[ytdCrimes$neighborhood == 54,])
cap_past_ytd <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 54 & ytdCrimes_past$crimeCatNum == 4 | ytdCrimes_past$neighborhood == 54 & ytdCrimes_past$crimeCatNum == 3,])
cap_pres_ytd <- nrow(ytdCrimes[ytdCrimes$neighborhood == 54 & ytdCrimes$crimeCatNum == 4 | ytdCrimes$neighborhood == 54 & ytdCrimes$crimeCatNum == 3,])
...
ytdCrimes %>%
  ...
  rename(., "Number of Crimes" = n) %>%
  pivot_wider(names_from = monthVar, values_from = "Number of Crimes") %>%
  replace(., is.na(.), 0) -> lp_pres
```

```{r lp Total Crimes Flextable past year, echo = FALSE}
part1crimes[!(part1crimes %in% lp_past$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(lp_past, crimeCatName = missing_category) -> lp_past
}
...
lp_past %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> lp_past
...
```{r lp Total Crimes Flextable current year, echo = FALSE}
part1crimes[!(part1crimes %in% lp_pres$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(lp_pres, crimeCatName = missing_category) -> lp_pres
}
...
lp_pres %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> lp_pres

#compare dataframes and get common columns
common_cols <- intersect(colnames(lp_pres[, (params$num + 1)]), colnames(lp_past[, (params$num + 1)]))

#assign to temporary dataframe
temp_past <- lp_past[,common_cols, drop=FALSE]
temp_pres <- lp_pres[,common_cols, drop=FALSE]
...
sub <- filter(monthCrimes_pres_sf, neighborhood == 54)
col <- character(0)
if("Aggravated Assault" %in% sub$crimeCatName){col <- c("Aggravated Assault" = "#e41a1c")}
if("Arson" %in% sub$crimeCatName){col <- c(col, "Arson" = "#A65628")}
if("Burgalry" %in% sub$crimeCatName){col <- c(col, "Burgalry" = "#377eb8")}
...
tc_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 58,])
tc_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 58,])
cap_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 58 & monthCrimes_past$crimeCatNum == 4 | monthCrimes_past$neighborhood == 58 & monthCrimes_past$crimeCatNum == 3,])
cap_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 58 & monthCrimes_pres$crimeCatNum == 4 | monthCrimes_pres$neighborhood == 58 & monthCrimes_pres$crimeCatNum == 3,])

tc_ytd_past <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 58,])
tc_ytdCurrent <- nrow(ytdCrimes[ytdCrimes$neighborhood == 58,])
cap_past_ytd <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 58 & ytdCrimes_past$crimeCatNum == 4 | ytdCrimes_past$neighborhood == 58 & ytdCrimes_past$crimeCatNum == 3,])
cap_pres_ytd <- nrow(ytdCrimes[ytdCrimes$neighborhood == 58 & ytdCrimes$crimeCatNum == 4 | ytdCrimes$neighborhood == 58 & ytdCrimes$crimeCatNum == 3,])
...
ytdCrimes %>%
  ...
  rename(., "Number of Crimes" = n) %>%
  pivot_wider(names_from = monthVar, values_from = "Number of Crimes") %>%
  replace(., is.na(.), 0) -> vd_pres
```

```{r vd Total Crimes Flextable past year, echo = FALSE}
part1crimes[!(part1crimes %in% vd_past$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(vd_past, crimeCatName = missing_category) -> vd_past
}
...
vd_past %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> vd_past
...
```{r vd Total Crimes Flextable current year, echo = FALSE}
part1crimes[!(part1crimes %in% vd_pres$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(vd_pres, crimeCatName = missing_category) -> vd_pres
}
...
vd_pres %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> vd_pres

#compare dataframes and get common columns
common_cols <- intersect(colnames(vd_pres[, (params$num + 1)]), colnames(vd_past[, (params$num + 1)]))

#assign to temporary dataframe
temp_past <- vd_past[,common_cols, drop=FALSE]
temp_pres <- vd_pres[,common_cols, drop=FALSE]
...
sub <- filter(monthCrimes_pres_sf, neighborhood == 58)
col <- character(0)
if("Aggravated Assault" %in% sub$crimeCatName){col <- c("Aggravated Assault" = "#e41a1c")}
if("Arson" %in% sub$crimeCatName){col <- c(col, "Arson" = "#A65628")}
if("Burgalry" %in% sub$crimeCatName){col <- c(col, "Burgalry" = "#377eb8")}
...
```{r AC Density Map Prep, eval = FALSE}
monthCrimes_pres_sf %>%
  filter(neighborhood == 51) %>%
...
```{r FP Density Map Prep, eval = FALSE}
monthCrimes_pres_sf %>%
...
```{eval = FALSE}
#lewis place lat lon coordinates
...
```{r LP Density Map Prep, eval = FALSE}
monthCrimes_pres_sf %>%
  filter(neighborhood == 54) %>%
  smooth_map(., bandwidth = 0.5, style = "pretty",
...
```{r VD Density Map Prep, eval = FALSE}
monthCrimes_pres_sf %>%
  filter(neighborhood == 58) %>%
  smooth_map(., bandwidth = 0.5, style = "pretty",
