...
file.remove(file.path(mydir, dir(path = mydir, pattern = "ac-fp-lp-vd-")))
...
convert_to_pdf(path = here::here("results", "presentations",  params$year, params$month, paste("ac-fp-lp-vd-", params$month, params$year, ".pptx", sep = "")),
               pdf_file = sub("[.]pptx", ".pdf", paste("~/Documents/GitHub/crime_interactive/crime_interactive/www/", "ac-fp-lp-vd-", params$month, params$year, ".pptx", sep = "")))
```
