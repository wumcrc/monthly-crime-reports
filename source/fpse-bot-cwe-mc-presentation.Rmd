...
common_cols <- intersect(colnames(fpse_2020[, (params$num + 1)]), colnames(fpse_2019[, (params$num + 1)]))

#assign to temporary dataframe
temp19 <- fpse_2019[,common_cols, drop=FALSE]
temp20 <- fpse_2020[,common_cols, drop=FALSE]
...
#compare dataframes and get common columns
common_cols <- intersect(colnames(bot_2020[, (params$num + 1)]), colnames(bot_2019[, (params$num + 1)]))

#assign to temporary dataframe
temp19 <- bot_2019[,common_cols, drop=FALSE]
temp20 <- bot_2020[,common_cols, drop=FALSE]
...
#compare dataframes and get common columns
common_cols <- intersect(colnames(cwe_2020[, (params$num + 1)]), colnames(cwe_2019[, (params$num + 1)]))

#assign to temporary dataframe
temp19 <- cwe_2019[,common_cols, drop=FALSE]
temp20 <- cwe_2020[,common_cols, drop=FALSE]
...
#compare dataframes and get common columns
common_cols <- intersect(colnames(mc_2020[, (params$num + 1)]), colnames(mc_2019[, (params$num + 1)]))

#assign to temporary dataframe
temp19 <- mc_2019[,common_cols, drop=FALSE]
temp20 <- mc_2020[,common_cols, drop=FALSE]
...
testarooni <- st_as_sf(monthCrimes20)%>%st_transform(4269)
monthCrimes20_sf %>%
  filter(neighborhood == 39) %>%
