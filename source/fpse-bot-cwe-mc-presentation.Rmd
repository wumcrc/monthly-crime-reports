...
common_cols <- intersect(colnames(fpse_2020), colnames(fpse_2019))
#drop columns that aren't shared
fpse_2020 <- fpse_2020[,common_cols, drop=FALSE]
fpse_2019 <- fpse_2019[,common_cols, drop=FALSE]
#assign colors, green is a decrease in crime, red is an increase, transparent is no change
colors <- unlist(fpse_2020[-1] - fpse_2019[-1]) %>% 
...
#compare dataframes and get common columns
common_cols <- intersect(colnames(bot_2020), colnames(bot_2019))
#drop columns that aren't shared
bot_2020 <- bot_2020[,common_cols, drop=FALSE]
bot_2019 <- bot_2019[,common_cols, drop=FALSE]
#assign colors, green is a decrease in crime, red is an increase, transparent is no change
colors <- unlist(bot_2020[-1] - bot_2019[-1]) %>% 
  cut(breaks = c(-Inf, -.1, 0.1, Inf),
      labels = c("green", "transparent", "red")) %>% 
  as.character()
#make flextable, color all columns except the first
...
#compare dataframes and get common columns
common_cols <- intersect(colnames(cwe_2020), colnames(cwe_2019))
#drop columns that aren't shared
cwe_2020 <- cwe_2020[,common_cols, drop=FALSE]
cwe_2019 <- cwe_2019[,common_cols, drop=FALSE]
#assign colors, green is a decrease in crime, red is an increase, transparent is no change
colors <- unlist(cwe_2020[-1] - cwe_2019[-1]) %>% 
  cut(breaks = c(-Inf, -.1, 0.1, Inf),
      labels = c("green", "transparent", "red")) %>% 
  as.character()
#make flextable, color all columns except the first
...
#compare dataframes and get common columns
common_cols <- intersect(colnames(mc_2020), colnames(mc_2019))
#drop columns that aren't shared
mc_2020 <- mc_2020[,common_cols, drop=FALSE]
mc_2019 <- mc_2019[,common_cols, drop=FALSE]
#assign colors, green is a decrease in crime, red is an increase, transparent is no change
colors <- unlist(mc_2020[-1] - mc_2019[-1]) %>% 
  cut(breaks = c(-Inf, -.1, 0.1, Inf),
      labels = c("green", "transparent", "red")) %>% 
  as.character()
#make flextable, color all columns except the first
