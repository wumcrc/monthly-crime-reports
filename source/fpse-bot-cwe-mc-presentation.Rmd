...
#tmap_options()
#create column ID for coloring flextable
colID <- c(params$abbr, "Total")
```
...
tc_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 39,])
tc_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 39,])
cap_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 39 & monthCrimes_past$crimeCatNum == 4 | monthCrimes_past$neighborhood == 39 & monthCrimes_past$crimeCatNum == 3,])
cap_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 39 & monthCrimes_pres$crimeCatNum == 4 | monthCrimes_pres$neighborhood == 39 & monthCrimes_pres$crimeCatNum == 3,])

tc_ytd_past <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 39,])
tc_ytdCurrent <- nrow(ytdCrimes[ytdCrimes$neighborhood == 39,])
cap_past_ytd <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 39 & ytdCrimes_past$crimeCatNum == 4 | ytdCrimes_past$neighborhood == 39 & ytdCrimes_past$crimeCatNum == 3,])
cap_pres_ytd <- nrow(ytdCrimes[ytdCrimes$neighborhood == 39 & ytdCrimes$crimeCatNum == 4 | ytdCrimes$neighborhood == 39 & ytdCrimes$crimeCatNum == 3,])
...
summary <- block_list(
  ...
  fpar(ftext(paste(" ", sep = ""), reg24),
       ...
       ftext(paste("compared to ", params$month, " ", params$pastyear, " (", tc_past, " total crimes)", sep = ""), reg24)),
  ...
  fpar(ftext(paste(" ", sep = ""), reg20),
       ...
       ftext(paste(" compared to ", params$month, " ", params$pastyear, " (", cap_past, " crimes against persons)", sep = ""), reg20)),
  fpar(ftext(sprint_2, boldline)),
  fpar(ftext(paste(" ", sep = ""), reg24),
       ftext(paste(pct_chg_ytd, "change ", sep = " "), color24b),
       ftext(paste("compared to this time in ", params$pastyear, " (", tc_ytd_past, " total crimes)", sep = ""), reg24)),
  ...
  fpar(ftext(paste(" ", sep = ""), reg20),
       ...
       ftext(paste(" compared to this time in ", params$pastyear, " (", cap_past_ytd, " crimes against persons)", sep = ""), reg20))
)
...
ytdCrimes %>%
  ...
  rename(., "Number of Crimes" = n) %>%
  pivot_wider(names_from = monthVar, values_from = "Number of Crimes") %>%
  replace(., is.na(.), 0) -> fpse_pres
```

```{r FPSE Total Crimes Flextable past year, echo = FALSE}
part1crimes[!(part1crimes %in% fpse_past$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(fpse_past, crimeCatName = missing_category) -> fpse_past
}
...
fpse_past %>% 
  ...
  rename(., "Part 1 Crimes" = crimeCatName) -> fpse_past
...
```{r FPSE Total Crimes Flextable current year, echo = FALSE}
part1crimes[!(part1crimes %in% fpse_pres$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(fpse_pres, crimeCatName = missing_category) -> fpse_pres
}
...
fpse_pres %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> fpse_pres

#compare dataframes and get common columns
common_cols <- intersect(colnames(fpse_pres[, (params$num + 1)]), colnames(fpse_past[, (params$num + 1)]))

#assign to temporary dataframe
temp_past <- fpse_past[,common_cols, drop=FALSE]
temp_pres <- fpse_pres[,common_cols, drop=FALSE]
...
sub <- filter(monthCrimes_pres_sf, neighborhood == 39)
col <- character(0)
...
tc_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 28,])
tc_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 28,])
cap_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 28 & monthCrimes_past$crimeCatNum == 4 | monthCrimes_past$neighborhood == 28 & monthCrimes_past$crimeCatNum == 3,])
cap_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 28 & monthCrimes_pres$crimeCatNum == 4 | monthCrimes_pres$neighborhood == 28 & monthCrimes_pres$crimeCatNum == 3,])

tc_ytd_past <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 28,])
tc_ytdCurrent <- nrow(ytdCrimes[ytdCrimes$neighborhood == 28,])
cap_past_ytd <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 28 & ytdCrimes_past$crimeCatNum == 4 | ytdCrimes_past$neighborhood == 28 & ytdCrimes_past$crimeCatNum == 3,])
cap_pres_ytd <- nrow(ytdCrimes[ytdCrimes$neighborhood == 28 & ytdCrimes$crimeCatNum == 4 | ytdCrimes$neighborhood == 28 & ytdCrimes$crimeCatNum == 3,])
...
ytdCrimes %>%
  ...
  rename(., "Number of Crimes" = n) %>%
  pivot_wider(names_from = monthVar, values_from = "Number of Crimes") %>%
  replace(., is.na(.), 0) -> bot_pres
```


```{r BOT Total Crimes Flextable past year, echo = FALSE}
part1crimes[!(part1crimes %in% bot_past$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(bot_past, crimeCatName = missing_category) -> bot_past
}
...
bot_past %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> bot_past
...
```{r BOT Total Crimes Flextable current year, echo = FALSE}
part1crimes[!(part1crimes %in% bot_pres$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(bot_pres, crimeCatName = missing_category) -> bot_pres
}
...
bot_pres %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> bot_pres

#compare dataframes and get common columns
common_cols <- intersect(colnames(bot_pres[, (params$num + 1)]), colnames(bot_past[, (params$num + 1)]))

#assign to temporary dataframe
temp_past <- bot_past[,common_cols, drop=FALSE]
temp_pres <- bot_pres[,common_cols, drop=FALSE]
...
sub <- filter(monthCrimes_pres_sf, neighborhood == 28)
col <- character(0)
if("Aggravated Assault" %in% sub$crimeCatName){col <- c("Aggravated Assault" = "#e41a1c")}
if("Arson" %in% sub$crimeCatName){col <- c(col, "Arson" = "#A65628")}
if("Burgalry" %in% sub$crimeCatName){col <- c(col, "Burgalry" = "#377eb8")}
...
tc_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 38,])
tc_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 38,])
cap_past <- nrow(monthCrimes_past[monthCrimes_past$neighborhood == 38 & monthCrimes_past$crimeCatNum == 4 | monthCrimes_past$neighborhood == 38 & monthCrimes_past$crimeCatNum == 3,])
cap_pres <- nrow(monthCrimes_pres[monthCrimes_pres$neighborhood == 38 & monthCrimes_pres$crimeCatNum == 4 | monthCrimes_pres$neighborhood == 38 & monthCrimes_pres$crimeCatNum == 3,])

tc_ytd_past <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 38,])
tc_ytdCurrent <- nrow(ytdCrimes[ytdCrimes$neighborhood == 38,])
cap_past_ytd <- nrow(ytdCrimes_past[ytdCrimes_past$neighborhood == 38 & ytdCrimes_past$crimeCatNum == 4 | ytdCrimes_past$neighborhood == 38 & ytdCrimes_past$crimeCatNum == 3,])
cap_pres_ytd <- nrow(ytdCrimes[ytdCrimes$neighborhood == 38 & ytdCrimes$crimeCatNum == 4 | ytdCrimes$neighborhood == 38 & ytdCrimes$crimeCatNum == 3,])
...
ytdCrimes %>%
  ...
  rename(., "Number of Crimes" = n) %>%
  pivot_wider(names_from = monthVar, values_from = "Number of Crimes") %>%
  replace(., is.na(.), 0) -> cwe_pres
```

```{r CWE Total Crimes Flextable past year, echo = FALSE}
part1crimes[!(part1crimes %in% cwe_past$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(cwe_past, crimeCatName = missing_category) -> cwe_past
}
...
cwe_past %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> cwe_past
...
```{r CWE Total Crimes Flextable current year, echo = FALSE}
part1crimes[!(part1crimes %in% cwe_pres$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(cwe_pres, crimeCatName = missing_category) -> cwe_pres
}
...
cwe_pres %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> cwe_pres

#compare dataframes and get common columns
common_cols <- intersect(colnames(cwe_pres[, (params$num + 1)]), colnames(cwe_past[, (params$num + 1)]))

#assign to temporary dataframe
temp_past <- cwe_past[,common_cols, drop=FALSE]
temp_pres <- cwe_pres[,common_cols, drop=FALSE]
...
sub <- filter(monthCrimes_pres_sf, neighborhood == 38)
col <- character(0)
if("Aggravated Assault" %in% sub$crimeCatName){col <- c("Aggravated Assault" = "#e41a1c")}
if("Arson" %in% sub$crimeCatName){col <- c(col, "Arson" = "#A65628")}
if("Burgalry" %in% sub$crimeCatName){col <- c(col, "Burgalry" = "#377eb8")}
...
tc_past <- nrow(mc_crimes_past)
tc_pres <- nrow(mc_crimes_pres)
cap_past <- nrow(mc_crimes_past[mc_crimes_past$crimeCatNum == 4 | mc_crimes_past$crimeCatNum == 3,])
cap_pres <- nrow(mc_crimes_pres[mc_crimes_pres$crimeCatNum == 4 | mc_crimes_pres$crimeCatNum == 3,])

tc_ytd_past <- nrow(mc_crimes_ytdpast)
tc_ytdCurrent <- nrow(mc_crimes_ytdpres)
cap_past_ytd <- nrow(mc_crimes_ytdpast[mc_crimes_ytdpast$crimeCatNum == 4 | mc_crimes_ytdpast$crimeCatNum == 3,])
cap_pres_ytd <- nrow(mc_crimes_ytdpres[mc_crimes_ytdpres$crimeCatNum == 4 | mc_crimes_ytdpres$crimeCatNum == 3,])
...
mc_crimes_ytdpres %>%
  ...
  rename(., "Number of Crimes" = n) %>%
  pivot_wider(names_from = monthVar, values_from = "Number of Crimes") %>%
  replace(., is.na(.), 0) -> mc_pres
```

```{r WUMC Total Crimes Flextable past year, echo = FALSE}
part1crimes[!(part1crimes %in% mc_past$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(mc_past, crimeCatName = missing_category) -> mc_past
}
...
mc_past %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> mc_past
...
```{r WUMC Total Crimes Flextable current year, echo = FALSE}
part1crimes[!(part1crimes %in% mc_pres$crimeCatName)] -> missing_category
is_empty(missing_category) -> test

if(test == FALSE) {
   add_row(mc_pres, crimeCatName = missing_category) -> mc_pres
}
...
mc_pres %>% 
  ...
  adorn_totals(., "col", name = "Total") %>%
  adorn_totals(., "row", name = "Total") %>%
  rename(., "Part 1 Crimes" = crimeCatName) -> mc_pres

#compare dataframes and get common columns
common_cols <- intersect(colnames(mc_pres[, (params$num + 1)]), colnames(mc_past[, (params$num + 1)]))

#assign to temporary dataframe
temp_past <- mc_past[,common_cols, drop=FALSE]
temp_pres <- mc_pres[,common_cols, drop=FALSE]
...
sub <- filter(mc_crimes_pres_sf, neighborhood == 38)
col <- character(0)
if("Aggravated Assault" %in% sub$crimeCatName){col <- c("Aggravated Assault" = "#e41a1c")}
if("Arson" %in% sub$crimeCatName){col <- c(col, "Arson" = "#A65628")}
if("Burgalry" %in% sub$crimeCatName){col <- c(col, "Burgalry" = "#377eb8")}
...
boundary <- filter(bound, NHD_NUM == 54)

monthCrimes_pres%>%
  filter(nbhd_name == "Lewis Place") -> temp
test <- st_as_sf(boundary)%>%st_transform(4269)

  ggmap(map)+
  stat_density_2d(
      aes(x = lon, y = lat, fill = ..level.., alpha = .6),
      size = .1, bins = 4, data = temp,
      geom = "polygon"
    )+
    geom_sf(data = test, fill = NA, color = "black", inherit.aes = FALSE)+
    ...
    #scale_fill_discrete(name = "Number of Crimes", labels = c("0-1", "1-2", "2-3"))+
    guides(alpha = FALSE)
...
#fpse lat long coordinates
map <- get_googlemap(center = c(lon = -90.2585, lat = 38.6259), zoom = 15)
boundary <- filter(bound, NHD_NUM == 39)
...
test <- st_as_sf(boundary)%>%st_transform(4269)
  ...
  ggmap(map)+
  stat_density_2d(
      aes(x = lon, y = lat, fill = as.factor(..level..), alpha = .6),
      size = .1, bins = 4, data = temp,
      geom = "polygon"
    )+
    geom_sf(data = test, fill = NA, color = "black", inherit.aes = FALSE)+
...
ggsave(here("results", params$year, params$month, "lp", "lp_density.jpeg"), dpi = 500)
...
```{r FPSE Density Map Prep, eval = FALSE}
testarooni <- st_as_sf(monthCrimes_pres)%>%st_transform(4269)
monthCrimes_pres_sf %>%
  filter(neighborhood == 39) %>%
...
```{r, eval=FALSE}
#cwe lat long coordinates
map <- get_googlemap(center = c(lon = -90.255369, lat = 38.640727), zoom = 14)
boundary <- filter(bound, NHD_NUM == 38)

monthCrimes_pres%>%
  filter(nbhd_name == "Central West End") -> temp
temp_bound <- st_as_sf(boundary)%>%st_transform(4269)
  ...
  stat_density_2d(
    ...
    geom_sf(data = temp_bound, fill = NA, color = "black", inherit.aes = FALSE)+
    theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank(),
        axis.title.y=element_blank(),
    ...
    scale_fill_discrete(name = "Number of Crimes", labels = c("0-1", "1-2", "2-3", "5"))+
    guides(alpha = FALSE)
  
ggsave(here("results", params$year, params$month, "cwe", "cwe_density.jpeg"), dpi = 500)
...
report%>%
  ...
  ph_with("Central West End Place: Crime Density Map",
               location = ph_location_type(
                 type = "title") )-> report
```


```{r CWE Density Map Prep, eval = FALSE}
monthCrimes_pres_sf %>%
  filter(neighborhood == 38) %>%
  smooth_map(., bandwidth = 0.5, style = "pretty",
...
file.remove(file.path(mydir, dir(path = mydir, pattern = "Center_crime")))
