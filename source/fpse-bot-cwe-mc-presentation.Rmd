...
```{r FPSE Total Crimes Knit, echo = FALSE, out.width = "20%"}
...
sprint_1 <- sprintf("The minimum number of crimes in one neighborhood was %s (%s)", dst_2_min_tot, dst_2_min_tot_nhd)
sprint_2 <- sprintf("The maximum number of crimes in one neighborhood was %s (%s)", dst_2_max_tot, dst_2_max_tot_nhd)
sprint_3 <- sprintf("The mean number of crimes in one neighborhood was %s", round(dst_2_total_mean, digits = 2))
sprint_4 <- sprintf("The minimum rate of crimes in one neighborhood was %s (%s)", round(dst_2_min_rate, digits = 2), dst_2_min_rate_nhd)
sprint_5 <- sprintf("The maximum rate of crimes in one neighborhood was %s (%s)", round(dst_2_max_rate, digits = 2), dst_2_max_rate_nhd)
sprint_6 <- sprintf("The mean rate of crimes in one neighborhood was %s", round(dst_2_rate_mean, digits = 2))
```
