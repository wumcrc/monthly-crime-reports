...
file.remove(file.path(mydir, dir(path = mydir, pattern = "fpse-bot-cwe-mc-")))
...
convert_to_pdf(path = here::here("results", "presentations",  params$year, params$month, paste("fpse-bot-cwe-mc-", params$month, params$year, ".pptx", sep = "")),
               pdf_file = sub("[.]pptx", ".pdf", paste("~/Documents/GitHub/crime_interactive/crime_interactive/www/", "fpse-bot-cwe-mc-", params$month, params$year, ".pptx", sep = "")))
```
