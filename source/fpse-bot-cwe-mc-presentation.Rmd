...
name <- comment(i)
  ...
  nbhd_past <- filter(monthCrimes_past, tiles == name)
  ytd_pres <- filter(ytdCrimes, tiles == name)
  ytd_past <- filter(ytdCrimes_past, tiles == name)
  pastyr <- filter(totalCrimes_past, tiles == name)
...
cap_pres_ytd <- nrow(ytd_pres[ytd_pres$crimeCatNum == 4 | ytd_past$crimeCatNum == 3,])
