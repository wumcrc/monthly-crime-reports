...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "fpse", "fpse_total_tm.jpeg"), width = 9.24, height = 7.47), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "bot", "bot_total_crimes.jpeg"), width = 8.52, height = 6.82), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "district-2", "dst2_rates.jpeg"), width = 6.03, height = 7.5),
          location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "cwe", "cwe_total_crimes.jpeg"), width = 9.5, height = 7.5), location = ph_location_type(type="title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "cwe", "mc_total_crimes.jpeg"), width = 8.11, height = 6.75), location = ph_location_type(type="body"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "cwe", "ctx_total_crimes.jpeg"), width = 9.12, height = 6.27), location = ph_location_type(type="title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "district-5", "dst5_rates.jpeg"), width = 7.1, height = 6.6), location = ph_location_type(type="title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "fpse", "fpse_day_night.jpeg"), width = 9.24, height = 7.47), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "fpse", "fpse_vlnt.jpeg"), width = 9.24, height = 7.47), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "fpse", "fpse_density.jpeg"), width = 9.24, height = 7.47), location = ph_location_type(type = "title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "fpse", "fpse_grove.jpeg"), width = 9.61, height = 4.43), location = ph_location_type(type = "body"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "cwe", "cwe_day_night.jpeg"), width = 9.5, height = 7.5), location = ph_location_type(type="title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "cwe", "cwe_vlnt.jpeg"), width = 9.5, height = 7.5), location = ph_location_type(type="title"), use_loc_size = FALSE)%>%
...
report%>%
  add_slide()%>%
  ph_with(external_img(here::here("results", params$year, params$month, "cwe", "cwe_density.jpeg"), width = 9.5, height = 7.5), location = ph_location_type(type="title"), use_loc_size = FALSE)%>%
