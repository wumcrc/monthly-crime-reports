...
ytdCrimes20 <- gw_geocode(ytdCrimes20, type = "local", class = "sf", address = "address", geocoder = geocoder)
...
#geocode results
totalCrimes19 <- gw_geocode(totalCrimes19, type = "local", class = "sf", address = "address", geocoder = geocoder)
