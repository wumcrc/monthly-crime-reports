...
ytdCrimes <- ytdCrimes %>% 
  ...
  mutate(tod = timeOcc)%>%
  mutate(tiles = ifelse(grepl("38", neighborhood), "cwe_tiles",
                                             ifelse(grepl("39", neighborhood), "fpse_tiles",
                                             ifelse(grepl("46", neighborhood), "sdb_tiles",  
                                             ifelse(grepl("47", neighborhood), "dbp_tiles",
                                             ifelse(grepl("48", neighborhood), "we_tiles",
                                             ifelse(grepl("49", neighborhood), "vp_tiles",       
                                             ifelse(grepl("51", neighborhood), "ac_tiles",       
                                             ifelse(grepl("53", neighborhood), "fp_tiles",       
                                             ifelse(grepl("54", neighborhood), "lp_tiles",       
                                             ifelse(grepl("58", neighborhood), "vd_tiles", NA)))))))))))%>%
