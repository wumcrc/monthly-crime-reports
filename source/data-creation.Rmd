...
output:
params:
  month: February                     # Refers to the month throughout the .Rmd Document | Change this to reflect the month you are analyzing
  ...
  date: "2020-02-01"                  # Pulls in the data for the most recent month | Change this each month
  pastdate: "2019-01-01"              # Compiles Year to Date Dataset for previous year | Leave at January 1st 2019
  pstdtmonth: "2019-02-01"            # Compiles Data for the most recent month of the previous year | This is the first day of the month
  pstdtmonth2: "2019-02-28"           # Compiles Data for the most recent month of the previous year | This is the last day of month | Must be the 30th or 31st
---
