...
ytdCrimes20$ileads_address[is.na(ytdCrimes20$ileads_address)] <- 0
...
district_crimes <- ytdCrimes20

# Filter out 10 neighborhoods we want to study
  ytdCrimes20%>%
    filter(neighborhood %in% c("28", "38", "39", "46", "47", "48", "49", "51", "53", "54", "58"))->ytdCrimes20
#Prepare data for geocoding
ytdCrimes20 <- mutate(ytdCrimes20, "address" = ifelse(ytdCrimes20$ileads_address > 0, paste(ytdCrimes20$ileads_address, ytdCrimes20$ileads_street, ", St. Louis, MO"), paste(ytdCrimes20$ileads_street, ", St. Louis, MO"))) 
#Geocode
ytdCrimes20 <- mutate_geocode(ytdCrimes20, address)
...
# all crimes 
monthCrimes20_sf <- st_as_sf(x = monthCrimes20,                         
           coords = c("lon", "lat"),
           crs = 4296)
ytdCrimes20_sf <- st_as_sf(x = ytdCrimes20,                         
           coords = c("lon", "lat"),
           crs = 4296)
