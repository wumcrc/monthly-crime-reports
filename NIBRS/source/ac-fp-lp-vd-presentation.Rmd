...
add_slide(report, layout = "Title and Content", master = "Facet")%>%
  ...
  overview <- temp_df%>%
    dplyr::group_by(type)%>%
    dplyr::summarise(Jan = sum(Jan), Feb = sum(Feb))%>%
