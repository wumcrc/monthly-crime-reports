...
```{r powerpoint title}
#title slide
  add_slide(report, layout = "Title Slide", master = "Office Theme")%>%
...
#history of crime reporting slide
  add_slide(report, layout = "Title and Content", master = "Office Theme")%>%
