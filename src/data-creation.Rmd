...
```{r}
# The following code filters out a dataset for an analysis of larcenies. It then adds a categorical variable based the type of larceny found in the description 
# variable. It also adds another variable that categorizes the value of the larceny. 
